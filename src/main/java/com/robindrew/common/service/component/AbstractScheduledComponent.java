...
public abstract class AbstractScheduledComponent extends AbstractScheduledService implements IComponent {
	...
	protected AbstractScheduledComponent(String name) {
		this.name = Check.notEmpty("name", name);
		this.log = LoggerFactory.getLogger(getClass());
	}

	protected AbstractScheduledComponent() {
