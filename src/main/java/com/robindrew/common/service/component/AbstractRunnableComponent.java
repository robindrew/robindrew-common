...
public abstract class AbstractRunnableComponent extends AbstractExecutionThreadService implements IComponent {
	...
	protected AbstractRunnableComponent(String name) {
		this.name = Check.notEmpty("name", name);
		this.log = LoggerFactory.getLogger(getClass());
	}

	protected AbstractRunnableComponent() {
